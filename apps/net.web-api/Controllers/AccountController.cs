...
using adworks.media_web_api.Models.AccountViewModels;
...
namespace adworks.media_web_api.Controllers
{
    ...
    {
        private readonly string _defaultOrgName = DtoHelper.DefaultOrganization;
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl = null)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    //add to organization
                    await _organizationService.AddUser(_defaultOrgName, model.Email);
